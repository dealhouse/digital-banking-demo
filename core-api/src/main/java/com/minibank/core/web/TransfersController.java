...
/**
 * Transfer endpoints consumed by the dashboard.
 * Keep controller thin: parse/validate request, delegate to TransferService, map response DTOs.
 * If you accept an Idempotency-Key header, document whether it is enforced or ignored in this demo.
 */
